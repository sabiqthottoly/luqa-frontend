...
const LeadsPage = () => {
  ...
  const handleChangePage = (event, newPage) => {
    dispatch(fetchLeads({ page: newPage + 1, pageSize: rowsPerPage }));
  };
  ...
  const leads = leadsData ? leadsData : [];
  console.log(leads, "wwwwwww");

  // Filter leads based on filter text
    ...
    <Box>
      ...
      <Paper>
        ...
        <TablePagination
          ...
          count={total}
          rowsPerPage={rowsPerPage}
          page={currentPage - 1} // currentPage is 1-based, but TablePagination expects 0-based
          onPageChange={handleChangePage}
          onRowsPerPageChange={handleChangeRowsPerPage}
        />
      </Paper>
